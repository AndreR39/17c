...
<script type="text/javascript" src="assets/js/bootstrap.bundle.min.js"></script> <!-- scripts para o Bootstrap funcionar corretamente -->

<?php
	include_once("php/conn.php"); // Ficheiro de conexão à bd
?>
